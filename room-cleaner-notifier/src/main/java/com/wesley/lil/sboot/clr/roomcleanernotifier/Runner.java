package com.wesley.lil.sboot.clr.roomcleanernotifier;
...
public class Runner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        rabbitTemplate.convertAndSend("operations","linkd.rooms.cleaner", objectMapper.writeValueAsString(payload));
        context.close();
    }
}
